...
describe('getAdminDashboard', () => {
    it('returns KPIs for admin dashboard', async () => {
        ...
        await (0, dashboard_controller_1.getAdminDashboard)(req, res);
...
describe('getProfesorDashboard', () => {
    it('returns profesor dashboard with categories and today trainings', async () => {
        ...
        const req = (0, helpers_1.mockReq)({ tenant: { school_id: 'school-1', role: 'profesor', user_id: 'user-1' } });
        const res = (0, helpers_1.mockRes)();
        await (0, dashboard_controller_1.getProfesorDashboard)(req, res);
        expect(res.json).toHaveBeenCalledWith(expect.objectContaining({
            categoriesCount: 2,
...
describe('getPadreDashboard', () => {
    it('returns parent dashboard with children', async () => {
        ...
        const req = (0, helpers_1.mockReq)({ tenant: { school_id: 'school-1', role: 'padre', user_id: 'parent-1' } });
        const res = (0, helpers_1.mockRes)();
        await (0, dashboard_controller_1.getPadreDashboard)(req, res);
        expect(res.json).toHaveBeenCalledWith(expect.objectContaining({
...
describe('getAlumnoDashboard', () => {
    it('returns alumno dashboard with streak and stats', async () => {
        ...
        const res = (0, helpers_1.mockRes)();
        await (0, dashboard_controller_1.getAlumnoDashboard)(req, res);
        expect(res.json).toHaveBeenCalledWith(expect.objectContaining({
            studentName: 'Pedro',
            currentStreak: 5,
            maxStreak: 12,
