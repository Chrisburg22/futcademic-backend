 ...
 */
export async function sendInvitationEmail(params: InvitationParams): Promise<boolean> {
  if (!SENDGRID_API_KEY) {
...
function buildInvitationHtml({ fullName, role, schoolName, activationLink }: InvitationParams): string {
